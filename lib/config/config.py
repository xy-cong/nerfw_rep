...
def parse_cfg(cfg, args):
    ...
    ##
    cfg.network.nerf.encode_a = args.encode_a
    cfg.network.nerf.N_a = args.N_a
    cfg.network.nerf.N_vocab = args.N_vocab
    ##
...
def make_cfg(args):
    def merge_cfg(cfg_file, cfg):
        with open(cfg_file, 'r') as f:
            ...
            # print(current_cfg)
            # print("#"*80)
        if 'parent_cfg' in current_cfg.keys(): # False
...
parser.add_argument('--local_rank', type=int, default=0) # 实际的gpu？ 
