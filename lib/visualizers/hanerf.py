...
class Visualizer:
    ...
    def visualize(self, output, batch):
        ...
        for b in range(B):
            ...
            content_img = output['content_rgb_1'][b].reshape(h, w, 3).detach().cpu().numpy()
            self.content_imgs.append(content_img)
            ...
            imageio.imwrite(os.path.join(cfg.result_dir, 'imgs/{:06d}_content.png'.format(idx)), content_img)
    ...
    def summarize(self):
        ...
        imageio.mimwrite(os.path.join(cfg.result_dir, 'color_content.mp4'), self.content_imgs, fps=cfg.fps)
